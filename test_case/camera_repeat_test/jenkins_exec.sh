...
img=$2
rf=$3
sshpass -p root scp /home/jenkins/eol_pytest_test/dataset/camera/img/${position}/${img} root@10.42.0.21:/nio/parameters/camera/dummy/${position}/image/${position}.bmp
